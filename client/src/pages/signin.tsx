...
export default function SignIn() {
  ...
  // Save user data (include token) in storage, cookies and context
  // The API returns { user, token } — ensure the token is passed into the
  // authStorage via the login() call so cookies/sessionStorage are created.
  const userWithToken = { ...(data.user || {}), token: data.token || data.authToken } as any;
  login(userWithToken);

  // Additionally save to localStorage for any legacy consumers
...
<div className="space-y-2">
  ...
  <div className="relative">
    <Input
      ...
      required
      className={`pr-10 pl-4 border-gray-200 focus:border-primary focus:ring-primary/20 ${
                    ...
                    <div className="w-full max-w-md p-6">
                      <div className="bg-white rounded-lg shadow-lg p-6">
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                          ...
                          Would you like to create an account to start shopping for beautiful flowers?
                        </p>
